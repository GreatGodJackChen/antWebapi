...
import StandardTable, { StandardTableColumnProps } from './components/index';
...
const { Option } = Select;
type IStatusMapType = 'success' | 'processing' | 'default' | 'error';
const statusMap = ['success', 'processing', 'default', 'error'];
const status = ['运行中', '禁用', '关闭', '异常'];
